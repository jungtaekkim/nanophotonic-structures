...
ALGORITHMS='pybobyqa powell de direct bo rs'
...
do
    ...
    do
        ...
        python ../src/optimize_algorithms_direct.py --structure $STRUCTURE --ind_materials $IND_MATERIALS --fidelity $FIDELITY --property $PROPERTY --algorithm $ALGORITHM --ind_round $IND_ROUND
        sleep 0.1s
    done
done
